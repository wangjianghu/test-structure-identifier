  ...
  static async multiScaleParallelRecognition(imageBlob: Blob, preprocessingSteps: string[]): Promise<RecognitionResult[]> {
    ...
    const result1 = await this.recognizeWithConfig(imageBlob, {
      ...
      params: {
        ...
        tessedit_char_blacklist: '史了一1Il|!0O',
        load_system_dawg: '0',
        load_freq_dawg: '0',
        load_unambig_dawg: '0',
        load_punc_dawg: '0',
    ...
    const result6 = await this.recognizeWithConfig(imageBlob, {
      ...
      params: {
        ...
        classify_enable_learning: '0',
        classify_enable_adaptive_matcher: '1',
        textord_noise_normratio: '0.05',
        tessedit_enable_dict_correction: '0',
        textord_min_linesize: '5.0',
        load_system_dawg: '0',
        load_freq_dawg: '0',
        load_unambig_dawg: '0',
        tessedit_char_blacklist: '史了一1Il|!0O'
    ...
    // 配置7: 选项括号专用识别
    const result7 = await this.recognizeWithConfig(imageBlob, {
      name: "选项括号专用",
      languages: ['eng'],
      psm: PSM.SINGLE_LINE,
      oem: OEM.LSTM_ONLY,
